		...
		() => {
			...
			gsap.fromTo(
				...
				{ opacity: 0, y: 100 },
				{
					...
					ease: 'power1.out',
					scrollTrigger: {
						trigger: '#home-performance-content',
						start: 'top bottom',
						end: 'bottom bottom',
						scrub: true,
	...
	return (
		<section ref={sectionRef} className='home-performance'>
			<div className='container'>
				...
				<div
					id='home-performance-content'
					className='home-performance__content'>
					<p>
						Run graphics-intensive workflows with a responsiveness that keeps up
						with your imagination. The M4 family of chips features a GPU with a
						second-generation hardware-accelerated ray tracing engine that
						renders images faster, so{' '}
						<span>gaming feels more immersive and realistic than ever.</span>{' '}
